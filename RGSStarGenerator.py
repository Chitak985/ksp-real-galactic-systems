...
class Star:
  def __init__(self, name, logGSurfaceGravity=None, luminositySun=None, tempK=None, massSuns=None, radiusSuns=None, rotationDays=None, description="Generated by a Python 3 script from a data array.", SIMBADdesg=None):
    self.name = name
    self.name2 = name.replace(" ","_").replace(".","")  # KSP-friendly name
    self.description = description
    if(luminositySun is None or tempK is None or massSuns is None or radiusSuns is None or rotationDays is None):
...
while True:
  ...
  try:
    ...
    print("Automated retrieval failed. Please enter information manually or type 'skip' to skip the star and add it as a placeholder instead.")
    q1 = input("[STAR "+str(counter)+"] Enter star name or skip: ").lower()
    if(q1 == "stop"):
      break
    elif(q1 == "skip"):
      q1 = input("[STAR "+str(counter)+"] Enter star name: ").lower()
      stars.append(Star(q1))
      continue
...
{{
  ...
  {{
    ...
    {{
      ...
      description = Full scan was unsuccessful. Information is corrupted.
      radius = 10000
      mass = 1E10
      rotates = true
      rotationPeriod = 1
